...
class WINGNUS(SupervisedLoadFile):
    ...
    def feature_extraction(self, df=None, training=False, features_set=None):
        ...
        for k, v in self.candidates.items():
            ...
            feature_array = [len(v.surface_forms) * idf, len(v.surface_forms)]
            ...
            feature_array.extend(
                (
                    ...
                    'abstract' in sections,
                    'introduction' in sections,
                    'related work' in sections,
                    'conclusions' in sections,
                    types.count('sectionHeader')
                    + types.count('subsectionHeader')
                    + types.count('subsubsectionHeader'),
                    sections.count('abstract'),
                    sections.count('introduction'),
                    sections.count('related work'),
                    sections.count('conclusions'),
                )
            )
